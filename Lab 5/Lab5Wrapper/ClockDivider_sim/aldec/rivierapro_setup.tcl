...
# ACDS 20.1 720 win32 2024.09.18.14:11:45
# ----------------------------------------
...
# ----------------------------------------
# If ClockDivider is one of several IP cores in your
...
if ![info exists TOP_LEVEL_NAME] { 
  set TOP_LEVEL_NAME "ClockDivider"
}
...
alias com {
  echo "\[exec\] com"
  eval  vcom $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/ClockDivider.vho"
}
