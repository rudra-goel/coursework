...
public class BSTStudentTest {
    ...
    @Test(timeout = TIMEOUT)
    public void testFindPathBetweenIntermediate() {
        tree.add(50);
        tree.add(25);
        tree.add(75);
        tree.add(12);
        ...
        expected.add(25);
        expected.add(37);
        assertEquals(expected, tree.findPathBetween(12, 37));
        expected.clear();
        
        expected.add(12);
        expected.add(25);
        assertEquals(expected, tree.findPathBetween(12, 25));
        expected.clear();
        ...
        expected.add(25);
        expected.add(12);
        assertEquals(expected, tree.findPathBetween(37, 12));
        expected.clear();

        // Test Case 4
        expected.add(37);
        expected.add(25);
        assertEquals(expected, tree.findPathBetween(37, 25));
        expected.clear();
        ...
        expected.add(50);
        expected.add(75);
        assertEquals(expected, tree.findPathBetween(25, 75));
        expected.clear();
        ...
        expected.add(75);
        expected.add(68);
        assertEquals(expected, tree.findPathBetween(25, 68));
        expected.clear();
        ...
        expected.add(75);
        expected.add(84);
        assertEquals(expected, tree.findPathBetween(25, 84));
        expected.clear();
        ...
        expected.add(50);
        expected.add(25);
        assertEquals(expected, tree.findPathBetween(75, 25));
        expected.clear();
        ...
        expected.add(50);
        expected.add(25);
        assertEquals(expected, tree.findPathBetween(84, 25));
        expected.clear();
        ...
        expected.add(50);
        expected.add(25);
        assertEquals(expected, tree.findPathBetween(68, 25));
        expected.clear();

        // Test Case 11
        expected.add(68);
        expected.add(75);
        assertEquals(expected, tree.findPathBetween(68, 75));
        expected.clear();
        ...
        expected.add(75);
        expected.add(50);
        assertEquals(expected, tree.findPathBetween(68, 50));
        expected.clear();
        ...
        expected.add(75);
        expected.add(84);
        assertEquals(expected, tree.findPathBetween(12, 84));
        expected.clear();
    ...
    //     assertEquals((Integer)25, tree.findPathBetween(12, 37).get(0));

    //     assertEquals((Integer)50, tree.findPathBetween(12, 75).get(0));
        
    //     assertEquals((Integer)50, tree.findPathBetween(37, 68).get(0));
