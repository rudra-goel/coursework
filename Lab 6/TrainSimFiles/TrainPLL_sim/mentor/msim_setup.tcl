...
# ----------------------------------------
# If TrainPLL is one of several IP cores in your
...
# ----------------------------------------
# ACDS 20.1 720 win32 2024.09.28.19:41:15
...
alias com {
  echo "\[exec\] com"
  eval  vcom $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/TrainPLL.vho"
}
