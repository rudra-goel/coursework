...
public class SortingStudentTest {
    ...
    // @Test(timeout = TIMEOUT) 
    // public void testExtractKthDigit() {
        
    //     System.out.println(Sorting.extractKthDigit(-9876, 1));
    //     System.out.println(Sorting.extractKthDigit(-9876, 2));
    //     System.out.println(Sorting.extractKthDigit(-9876, 3));
    //     System.out.println(Sorting.extractKthDigit(-9876, 4));
        
    // }
    
    // @Test(timeout = TIMEOUT)
    // public void testDetermineK() {
    //     int[] unsortedArray = new int[]{54, 28, 58, 84, 20, 122, -85, 3, Integer.MAX_VALUE};
    //     System.out.println(Sorting.determineK(unsortedArray));
    // }
